...
namespace Reticle
{
	extern SKY_API const FName Inner_RGBA;
	extern SKY_API const FName RoundedCornerScale;
	extern SKY_API const FName ShapeCutThickness;
}

namespace Ammo
{
	extern SKY_API const FName Rounds_Current;
	extern SKY_API const FName Rounds_Max;
}
 ...
 */
UCLASS()
class SKY_API UShooterReticle : public UUserWidget
{
	GENERATED_BODY()
public:
